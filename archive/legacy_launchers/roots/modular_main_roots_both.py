...
args.network_type = "both_for_roots_2"  #"both_for_roots_2"  #"both_for_roots"
...
if args.dataset_type=="roots_json":
    ...
    k = "5"
    args.dataset_path = os.path.join("E:\\roots_project", "Grapes_K_fold", "K_" + k)
                                    # , "Tube 20_renamed")
    ...
    args.train_csv_leaf_number_file = os.path.join(args.dataset_path, 'sub_Train_'+k, 'Train.csv')   #'Train.csv' ) #'Train_limit_5.csv')
    args.train_csv_leaf_location_file = os.path.join(args.dataset_path, 'sub_Train_'+k, "Train_pointsOutpu.csv") #"Train_pointsOutput.csv") #"Train_pointsOutput_limit_5.csv")
    args.train_json_file = os.path.join(args.dataset_path, 'sub_Train_'+k, "Train_Dia_Length_Color.txt") #"Train_Dia_Length_Color.txt") #"Train_Dia_and_Length.txt" "Train_all_info.txt" "Train_Dia_Length_Color_limit_5.txt"

    args.val_csv_leaf_number_file = os.path.join(args.dataset_path,  "sub_"+val_set+"_"+k,  val_set+".csv") #"Val.csv")  # "Val_limit_5.csv"
    args.val_csv_leaf_location_file = os.path.join(args.dataset_path, "sub_"+val_set+"_"+k, val_set+"_pointsOutput.csv") # "Val_pointsOutput.csv") #"Val_pointsOutput_limit_5.csv")  #'sub_Val', "Val_pointsOutput.csv")
    args.val_json_file = os.path.join(args.dataset_path,  "sub_"+val_set+"_"+k, val_set+"_Dia_Length_Color.txt") # "Val_Dia_Length_Color.txt") #"Val_all_info.txt") # "Val_Dia_Length_Color_limit_5.txt")  # "Val_Dia_Length_Color.txt"  #"Val_Dia_and_Length.txt"

    args.base_dir = None  # args.dataset_path

    test_epoch = "209" #"199" #"111" #"119" #"196" #"229" #"90" #"128" #"229" #"217" # "290" #"90" #"80" #"69" # "2" #"231" #"198" #"15" #"231" #"85" #"231"
    weights_dir = "2024-07-23_171737" #"2024-06-19_194224" #"2024-06-19_194041" #"2024-06-18_152231" #"2024-06-18_123358" # "2023-05-28_194055" #"2023-05-23_162315" #"2023-06-27_025106" # "2023-05-28_194055" #"2023-05-24_155926" # "2023-05-25_175752" #"2023-05-23_162315" #"2023-05-23_162613" #"2023-05-20_230659" # "2023-05-18_183327" #"2023-02-28_184758" #"2023-03-05_111030" #"2023-03-04_102708" #"2023-03-03_232404" #"2023-02-28_184758" #"2023-02-28_184758" #"2023-02-28_125804"
    ...
    args.Results_path = os.path.join(args.dataset_path, "Results", "both_roots_2_Reg") #, "both_2_detect_3Sets\\reg", "I0.5_s0.7_10_dia_100_color\\trained_all")
    ...
    args.test_dir = os.path.join(args.Results_path, val_set) #+"Train89_Test241") #, "Test_I_0.5_s_0.7_3")
...
if args.dataset_name == "roots":
    ...
    config.AttributeEstimation.map_1_R = (6, 6)
...
# True if loading the model (with pre-trained weights)
...
# True- if loading  pre-trained weights but not the model
...
args.partial_weights_dir = "" #os.path.join(args.dataset_path, "Results", "detection_withEval", weights_dir , "saved_weights_epoch_"+test_epoch)
