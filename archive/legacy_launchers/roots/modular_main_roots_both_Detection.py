...
#args.current_gpu = int(current_gpu)
...
args.dataset_type = "roots_json" #"csv_LCC" #"kcsv" #"coco"

args.network_type = "detection"   # "detection" #"both_for_roots_2"  #"both_for_roots"
...
config.General.model_name = "model_detection"
...
# TODO: THIS IS MY BEST EVER DATA FORMAT FOR EVERYTHING!!!!!!!!!!!!!
    ...
    #k = "1"
    args.dataset_path = os.path.join("E:\\roots_project", "Grapevine_all") #"Grapes_K_fold", "K_"+k) #, "Tube 20_renamed")
    ...
    args.train_csv_leaf_number_file = os.path.join(args.dataset_path, 'sub_Train', 'Train.csv') #'sub_Train_'+k, 'sub_Train'  #'Train.csv' ) #'Train_limit_5.csv')
    args.train_csv_leaf_location_file = os.path.join(args.dataset_path, 'sub_Train', "Train_pointsOutput.csv") #'sub_Train_'+k, "Train_pointsOutput.csv") #"Train_pointsOutput.csv") #"Train_pointsOutput_limit_5.csv")
    args.train_json_file = os.path.join(args.dataset_path,'sub_Train', "Train_Dia_Length_Color.txt") #'sub_Train_'+k, "Train_Dia_Length_Color.txt") #"Train_Dia_Length_Color.txt") #"Train_Dia_and_Length.txt" "Train_all_info.txt" "Train_Dia_Length_Color_limit_5.txt"

    args.val_csv_leaf_number_file = os.path.join(args.dataset_path, "sub_"+val_set, val_set+".csv") #"sub_"+val_set+"_"+k,  val_set+".csv") #"Val.csv")  # "Val_limit_5.csv"
    args.val_csv_leaf_location_file = os.path.join(args.dataset_path, "sub_"+val_set, val_set+"_pointsOutput.csv") #"sub_"+val_set+"_"+k, val_set+"_pointsOutput.csv") # "Val_pointsOutput.csv") #"Val_pointsOutput_limit_5.csv")  #'sub_Val', "Val_pointsOutput.csv")
    args.val_json_file = os.path.join(args.dataset_path, "sub_"+val_set, val_set+"_Dia_Length_Color.txt") #"sub_"+val_set+"_"+k, val_set+"_Dia_Length_Color.txt") # "Val_Dia_Length_Color.txt") #"Val_all_info.txt") # "Val_Dia_Length_Color_limit_5.txt")  # "Val_Dia_Length_Color.txt"  #"Val_Dia_and_Length.txt"

    args.base_dir = None  # args.dataset_path

    test_epoch = "69" #"69" #"56" #"280" #"136" #"81" #"119" #"196" #"229" #"90" #"128" #"229" #"217" # "290" #"90" #"80" #"69" # "2" #"231" #"198" #"15" #"231" #"85" #"231"
    weights_dir = "2023-05-20_230659" #"2023-05-20_230659" #"2024-07-07_001752" #"2024-06-27_150210" #"2024-06-26_141312" #"2024-06-26_141802" #"2024-06-18_123358" #"2024-06-18_152231" # "2023-05-28_194055" #"2023-05-23_162315" #"2023-06-27_025106" # "2023-05-28_194055" #"2023-05-24_155926" # "2023-05-25_175752" #"2023-05-23_162315" #"2023-05-23_162613" #"2023-05-20_230659" # "2023-05-18_183327" #"2023-02-28_184758" #"2023-03-05_111030" #"2023-03-04_102708" #"2023-03-03_232404" #"2023-02-28_184758" #"2023-02-28_184758" #"2023-02-28_125804"
    ...
    args.Results_path = os.path.join(args.dataset_path, "Results", "ReCheck_Detect_3sets")
    #"ReCheck_both_2_Reg"  #"ReCheck_Detect_3sets"#"both_roots_2_Reg" "ReCheck_Detect_allRoots"
    #"detection_withEval_limit_5" ) #"detection_withEval_inBoth"  #"points_both_checkFlops") #, "both_2_detect_3Sets\\reg", "I0.5_s0.7_10_dia_100_color\\trained_all")
    ...
    args.test_dir = os.path.join(args.Results_path, val_set, "check_Flops") #, "Test_I_0.5_s_0.7_3")
    ...
    if args.test_dir != "":
        ...
        args.txt_results = os.path.join( args.Results_path, "results_train.txt")  # "val", "val_epoch"+test_epoch+".txt")
...
args.separate_training = False #should be False, re-check why was needed??

args.evaluate_detection = True # this or args.do_counting must be TRUE

args.eval_detection_params = False

config.Detection.min_score_list = [config.Detection.min_score]          #[0.05, 0.85, 0.9, 0.95]  #[0.7]
config.Detection.iou_threshold_list = [config.Detection.iou_threshold]  #[0.3, 0.5, 0.7, 0.9]     #[0.5]

args.evaluate_both = False # relevant to validation, not train
...
args.model_path = ""
#os.path.join(args.dataset_path, "Results","both_2_detect_3Sets\\reg\\I0.5_s0.7_10_dia_100_color\\trained_all", weights_dir, "legonet_epoch="+test_epoch+".pt")
#os.path.join(args.Results_path, weights_dir, "legonet_epoch="+test_epoch+".pt") #"legonet_final.pt") #"legonet_epoch="+test_epoch+".pt")
...
args.load_partial_weights_only = True # True means only detection weights
args.load_model_and_partial = False # True for composing pre-trained network

args.partial_weights_dir = os.path.join("C:\\Users\\Aragorn\\Desktop", "", "Three_datasets_detection\\Results\\detection", weights_dir, "saved_weights_epoch_" + test_epoch)
                                        #"Det_I0.5_S0.7", weights_dir , "saved_"+test_epoch)

                                       # "\\Three_datasets_detection\\Results\\detection", weights_dir , "saved_weights_epoch_"+test_epoch)
#os.path.join("C:\\Users\\Aragorn\\Desktop\\roots project\\Three_datasets_detection\\Results\\detection", weights_dir , "saved_weights_epoch_"+test_epoch)
#os.path.join(args.dataset_path, "Results", 'detection_withEval', weights_dir , "saved_weights_epoch_"+test_epoch)
#"2024-06-18_123358", "saved_weights_epoch_196")
                                    #os.path.join("C:\\Users\\Aragorn\\Desktop\\roots project",
...
args.additional_modules_weights = "" # {"backbone_2":limit5Path,
                                  #"find_2": limit5Path,
...
print("freeze_detection: ", args.freeze_detection)
