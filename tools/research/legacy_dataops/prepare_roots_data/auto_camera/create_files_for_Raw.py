...
name_match_file = "D:\\Faina\\roots_project\\Autocam image for CNN model\\Images for training\\Training dataset_automated camera\\Autocam3_files" \
                  "\\images_match_newAutoCam.csv"
#"D:\\Faina\\roots_project\\Rootfly_cam3\\Aug 22\\name_match.csv"

input_file =  os.path.join("D:\\Faina\\roots_project", "Autocam image for CNN model\\Images for training\\Training dataset_automated camera\\",
                           "original","sub_Train", "Train.csv")
...
output_file = os.path.join("D:\\Faina\\roots_project","Autocam image for CNN model\\Images for training\\Training dataset_automated camera\\",
                           "original","sub_Train", "Train_TRL_with_names.csv")
