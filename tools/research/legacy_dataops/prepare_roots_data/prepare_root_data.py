...
data_path = os.path.join("D:/Faina/roots_project", dataset_name) # "manual_camera", dataset_name)

procc_img_path = os.path.join(data_path, "processed_img")

raw_files = ["cam3_20220617.csv"] #["kaining_pepper_2021.csv"]

output_csv_file = os.path.join(data_path, "June 22", "TRL_June.csv")
...
for file in raw_files:
    path_to_files.append(os.path.join(data_path, "June 22", file))
...
dir_list = os.listdir(procc_img_path)
